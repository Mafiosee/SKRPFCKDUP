...
const MaskAndGlassesBlock: React.FC<Props> = ({
  activeSkinSlot,
  setActiveSkinSlot,
  setDragIsActive,
  dragSkinId,
  ...
  return (
    <div className="MaskAndGlassesBlock">
      <BlockFrame className="blockFrame">
        <>
          ...
          <BlockSlotSelect
            ...
            slots={SkinCategoryConfig[SkinCategory.MaskAndGlasses].slots.map(
              (slot) => ({
                slot,
...
export default MaskAndGlassesBlock
