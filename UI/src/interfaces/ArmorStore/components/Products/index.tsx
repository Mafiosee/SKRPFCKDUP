		...
		products
			.filter((product) => {
				...
				const isCategoryMatch =
					activeCategory == null || product?.charSlot === activeCategory || product?.itemType === activeCategory
				return isQualityMatch && isSearchMatch && isCategoryMatch
			})
			.map(({ id, quality, image, name, price, protection, damage }) => {
				...
				return (
					...
					>
						...
						<div className='content'>
							...
							<div className='row'>
								<div className='parameter -condition'>100</div>
								<div className='separator' />
								{protection != null && protection > 0 && (
									<div className='parameter -protection'>{protection}</div>
								)}
								{protection != null && protection > 0 && damage != null && damage > 0 && (
									<div className='separator' />
								)}
