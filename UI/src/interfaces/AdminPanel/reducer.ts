...
const initialState: AdminPanel = {
  ...
  sections: [
    ...
    {
      id: AdminPanelSections.PunishedPlayers,
      name: 'Наказания',
    },
  ],
  adminInfo: {
