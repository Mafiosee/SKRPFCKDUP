...
import { RegExpName, ValuesKeys } from '../../types'
...
import { CreateCharacterEvents, CreateCharacterSetNamePayload } from '../../../../shared/characterEditor/events'
		...
		>
			...
			>
				...
				>
					...
					<div className='button' onClick={() => setIsOpenRules(true)}>Ограничения по именам</div>
					<div className='row'>
