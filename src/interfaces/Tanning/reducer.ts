...
const initialState: TanningState = {
	isOpen: false,
	recipes: [
		{
...
export const tanningSlice = createSlice({
	name: 'tanning',
	initialState,
	reducers: {
		show(state) {
...
export const tanningReducer = tanningSlice.reducer
export const tanningActions = tanningSlice.actions
