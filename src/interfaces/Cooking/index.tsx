...
import { AlchemyTableEvents, CookingEvents } from '../../shared/Crafts/events'
...
const Cooking = () => {
	...
	// useEffect(() => {
	// 	setTimeout(() => dispatch(cookingActions.show()), 150)
	// }, [])
	...
	useEffect(() => {
		if (!isOpen) {
			...
			dispatch(
				notificationsActions.removeFromInterface(InterfacesId.Cooking),
			)
		}
	}, [dispatch, isOpen])
